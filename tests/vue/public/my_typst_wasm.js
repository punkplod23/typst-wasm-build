/* @ts-self-types="./my_typst_wasm.d.ts" */

/**
 * @param {string} path
 * @param {Uint8Array} data
 */
export function add_file(path, data) {
 ...
 * @param {Uint8Array} data
 */
export function add_font(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_export);
    const len0 = WASM_VECTOR_LEN;
    wasm.add_font(ptr0, len0);
}
 ...
 * @returns {Uint8Array}
 */
export function compile_to_pdf(text) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(text, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.compile_to_pdf(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('my_typst_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
